            ...
            <div className="bg-white rounded-lg shadow-md p-8 space-y-8">
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  Muneem Ji's website for personal, non-commercial transitory viewing only. This is the grant of a
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  The materials on Muneem Ji's website are provided on an 'as is' basis. We make no warranties,
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  In no event shall Muneem Ji or its suppliers be liable for any damages (including, without limitation,
                  damages for loss of data or profit, or due to business interruption) arising out of the use or
                  inability to use the materials on Muneem Ji's website.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  The materials appearing on Muneem Ji's website could include technical, typographical, or photographic
                  errors. We do not warrant that any of the materials on our website are accurate, complete, or current.
                  We reserve the right to make changes to the materials contained on our website at any time without
                  notice.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  We may revise these Terms and Conditions for our website at any time without notice. By using this
