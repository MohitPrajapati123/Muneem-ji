      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-between items-center h-20">
          ...
          <nav className="hidden md:flex gap-8 items-center">
            <Link to="/taxation" className="text-gray-700 hover:text-amber-600 transition font-medium">
             Taxation
            </Link>
            <Link to="/financial-reporting" className="text-gray-700 hover:text-amber-600 transition font-medium">
              Financial-Reporting
            </Link>
            <Link to="/labour-legal-compliance" className="text-gray-700 hover:text-amber-600 transition font-medium">
              Labour & Legal Compliance
            </Link>
            <Link to="/registration" className="text-gray-700 hover:text-amber-600 transition font-medium">
              Registration
            </Link>
            <Link to="/accounting" className="text-gray-700 hover:text-amber-600 transition font-medium">
              Accounting
            </Link>
            <Link
              to="/contact"
